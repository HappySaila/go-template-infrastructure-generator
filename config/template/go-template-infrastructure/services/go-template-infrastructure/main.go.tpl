...
import (
	"context"
	"dev/[[.Dashed]].git/services/[[.Dashed]]/handlers"
	some_db "dev/[[.Dashed]].git/thirdparty/some-db"
	"fmt"
...
func run(log *log.Logger) error {
	...
	// Initialise [[.Sentence]] Service
	[[.Camel]] := handlers.Init(db, log)
	...
	// Initialise web app
	webApp := handlers.API(log, [[.Camel]], shutdown)
